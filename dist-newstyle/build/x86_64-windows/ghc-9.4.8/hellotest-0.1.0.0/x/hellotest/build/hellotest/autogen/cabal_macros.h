...
/* package hellotest-0.1.0.0 */
#ifndef VERSION_hellotest
#define VERSION_hellotest "0.1.0.0"
#endif /* VERSION_hellotest */
#ifndef MIN_VERSION_hellotest
#define MIN_VERSION_hellotest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hellotest */
...
#define CURRENT_COMPONENT_ID "hellotest-0.1.0.0-inplace-hellotest"
